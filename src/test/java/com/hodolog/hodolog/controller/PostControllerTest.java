...
import com.hodolog.hodolog.request.post.PostCreate;
import com.hodolog.hodolog.request.post.PostEdit;
...
class PostControllerTest {
    ...
    @Test
    @DisplayName("글 작성")
    @HodologMockUser(name = "홍길동", email = "hodolman98@gmail.com", password = "1234")
